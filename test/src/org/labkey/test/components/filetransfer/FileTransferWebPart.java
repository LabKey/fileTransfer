...
package org.labkey.test.components.filetransfer;
 ...
 */
public class FileTransferWebPart extends BodyWebPart<FileTransferWebPart.ElementCache>
{
    public FileTransferWebPart(WebDriver driver)
    {
        this(driver, 0);
    }
